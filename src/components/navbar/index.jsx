            ...
            <div className="container">
                <div className="row p-3">
                    <div className="col-md pb-2 pb-md-0">
                        <svg width="1em" height="1.5em" viewBox="0 0 16 16" className="bi bi-envelope" fillRule="currentColor" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a href="#" className="text-white ml-2">shahab.banijamali94@gmail.com</a>
                    </div>
                    <div className="col-md text-md-center pb-2 pb-md-0">
                        <svg width="1.5em" height="1.5em" viewBox="0 0 16 16" className="bi bi-globe" fillRule="currentColor" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a href="#" className="text-white ml-2">www.mapsahr.com</a>
                    </div>
                    <div className="col-md text-md-right">
                        ...
                        <a href="#" className="text-white ml-2">+989368205655</a>
                    </div>
                </div>
            </div>
        </nav>
